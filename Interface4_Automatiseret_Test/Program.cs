...
namespace Interface4_Automatiseret_Test
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            SendStuff sendStuff_Object = new SendStuff();
            ...
            CheckoutManager checkoutManager_Object2 = new CheckoutManager(creditCardProcessor_Object, eMailService_Object);
            ...
            CheckoutManager checkoutManager_Object4 = new CheckoutManager(creditCardProcessor_Object, sendStuff_Object);
            Console.WriteLine();
            checkoutManager_Object.CompleteOrder(500);
            Console.WriteLine();
            checkoutManager_Object1.CompleteOrder(250);
            Console.WriteLine();
            checkoutManager_Object2.CompleteOrder(1500);
            Console.WriteLine();
            checkoutManager_Object4.CompleteOrder(2500);
